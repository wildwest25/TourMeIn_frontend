      ...
      <div class="row justify-content-md-center">
        <div class="col-lg-6">
          <form>
            ...
            <div
              class="form-group"
              :class="{ error: validation.hasError('newFirstname') }"
            >
              ...
              />
              <div class="message">
                {{ validation.firstError("newFirstname") }}
              </div>
            </div>
            <div
              class="form-group"
              :class="{ error: validation.hasError('newLastname') }"
            >
              ...
              />
              <div class="message">
                {{ validation.firstError("newLastname") }}
              </div>
            </div>
            <div
              class="form-inline"
              :class="{ error: validation.hasError('newGender') }"
            >
              ...
              <div class="message">
                {{ validation.firstError("newGender") }}
              </div>
            </div>
            <div
              class="form-inline"
              :class="{ error: validation.hasError('newdob') }"
            >
              ...
              />
              <div id="Text_age">
                You must be atleast 18 years old to register
              </div>
            ...
            <div
              class="form-inline"
              :class="{ error: validation.hasError('isGuide') }"
            >
            ...
            <div
              class="form-inline"
              :class="{ error: validation.hasError('newCity') }"
            >
    ...
    postNewInfo() {
      this.$validate().then(async (success) => {
        if (success) {
          ...
          try {
            let uspjeh = await Auth.register(
              email,
              password,
              firstname,
              lastname,
